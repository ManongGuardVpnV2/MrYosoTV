...
const DEVIL_BOOK = 'https://d64gsuwffb70l.cloudfront.net/6966ff2969d41bac5afce556_1768357781130_1774fa95.jpg';
const ANGEL_BOOK = 'https://d64gsuwffb70l.cloudfront.net/6966ff2969d41bac5afce556_1768357798348_299e5440.jpg';
const PADLOCK = 'https://d64gsuwffb70l.cloudfront.net/6966ff2969d41bac5afce556_1768357839315_79c82324.png';
...
const EnchantedAuth: React.FC<EnchantedAuthProps> = ({ onAuthSuccess }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (authMode === 'signup') {
      ...
      const result = await signup(email, password, username, deviceFingerprint);
      if (result.success) {
        onAuthSuccess();
      } else {
    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-4">
        ...
        <div className="text-center mb-8 animate-fade-in">
          <h1 className="text-5xl md:text-7xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 via-amber-500 to-yellow-600 drop-shadow-lg mb-2"
        ...
        <div className="flex items-center justify-center gap-4 md:gap-8 lg:gap-16 relative">
          ...
          >
            <div className="relative group">
              <img 
                ...
                style={{ 
                  boxShadow: '0 0 40px rgba(220, 38, 38, 0.5), 0 20px 40px rgba(0,0,0,0.5)',
          ...
          >
            <div className="relative">
              {isUnlocked ? (
                <Unlock className="w-16 h-16 md:w-24 md:h-24 text-yellow-400 drop-shadow-lg" 
          ...
          >
            <div className="relative group">
              <img 
                ...
                className="w-32 h-44 md:w-48 md:h-64 lg:w-56 lg:h-72 object-cover rounded-lg shadow-2xl transition-transform duration-500 group-hover:rotate-y-10"
                style={{ 
                  boxShadow: '0 0 40px rgba(234, 179, 8, 0.5), 0 20px 40px rgba(0,0,0,0.5)',
      ...
      {showModal && !isUnlocked && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm animate-fade-in">
          <div className="bg-gradient-to-br from-purple-900 via-purple-800 to-indigo-900 rounded-2xl p-6 md:p-8 max-w-md w-full shadow-2xl border border-purple-500/30 animate-scale-in"
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              >
                {isLoading ? (
                  ...
                  authMode === 'login' ? 'Enter the Light' : 'Embrace the Darkness'
                )}
              </button>
            </form>
